from gibson2.envs.mushrl_pin_igibson_env_basearm import iGibsonMPEnv
...
class CriticNetwork(nn.Module):
    def __init__(self, input_shape, output_shape, n_features, **kwargs):
        ...
        self._h1 = nn.Linear(6 + 6, n_features)
...
def experiment(alg, n_epochs, n_steps, n_steps_test):
    ...
    print("Input Shapre: ", actor_input_shape[0], mdp.info.action_space.shape[0])
